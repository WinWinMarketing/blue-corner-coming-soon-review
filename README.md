...
Five content screens followed by one global navy crisis band and the final light sign-off row:
...
The crisis band appears once immediately after the content, followed by the light sign-off row (wordmark, links, copyright).
...
- One global crisis band follows `main` before the footer: 9-8-8 call and text as yellow tap targets, 9-1-1 for immediate danger, and the helpline named so nobody has to guess who answers.
