...
export const conceptAdditions = Object.freeze({
  ...
  readinessCheck: Object.freeze({
    ...
    intro: "There is no score, result, or diagnosis here. These prompts only help you notice what kind of next step feels possible today.",
    prompts: Object.freeze([
      Object.freeze({ key: "talk", legend: "Talking to someone", options: Object.freeze(["Feels possible today", "Maybe, with a smaller first step", "Not today"]) }),
      Object.freeze({ key: "time", legend: "Making ten quiet minutes", options: Object.freeze(["Feels possible today", "Maybe, with help protecting the time", "Not today"]) }),
      Object.freeze({ key: "choice", legend: "Choosing what happens next", options: Object.freeze(["I want to choose it myself", "I want help seeing the options", "I am not ready to choose"]) }),
    ]),
    note: "Your answers stay on this page, are not scored, and are cleared when you leave or restore the page.",
    fallback: "JavaScript is optional. Read the choices as private reflection prompts; no answer is better than another.",
  }),
  resetCard: Object.freeze({
    type: "reset-card",
    title: "Between-round reset",
    intro: "A short reset can create a little room before the next thing. Move at your own pace and stop whenever you want.",
    steps: Object.freeze([
      Object.freeze({ heading: "Put both feet somewhere steady", body: "Notice the support under you without changing anything else." }),
      Object.freeze({ heading: "Let one breath take its time", body: "No special count. Just notice one inhale and one exhale." }),
      Object.freeze({ heading: "Name the next small thing", body: "Choose one immediate action, or choose to pause a little longer." }),
    ]),
    note: "This is a general grounding prompt, not therapy, medical advice, or a substitute for crisis support.",
    fallback: "JavaScript is optional. All three reset steps are visible below and can be followed in any order.",
  }),
  supportRequest: Object.freeze({
    type: "support-request",
    title: "Ask for support",
    intro: "A direct request can make it easier for someone to show up without guessing. You control the person, the ask, and the details.",
    people: Object.freeze(["a friend", "my partner", "a family member", "a coworker or manager"]),
    asks: Object.freeze(["listen for ten minutes", "check in with me tomorrow", "help me protect some time", "help me find a support option"]),
    fallback: "JavaScript is optional. Pick one person and one specific ask, then write the request in your own words. Nothing sends.",
  }),
  workdayBoundary: Object.freeze({
    type: "workday-boundary",
    title: "Workday boundary",
    intro: "A workplace boundary can be clear without sharing personal details. Adjust the language to fit your role and situation.",
    contexts: Object.freeze(["a meeting or call", "a deadline or workload", "messages outside work hours"]),
    boundaries: Object.freeze(["I need a short pause before I respond.", "I need us to reset the priority and timing.", "I will pick this up during my next work block."]),
    note: "This is a drafting aid, not legal, medical, or workplace-policy advice. Nothing sends from this page.",
    fallback: "JavaScript is optional. Combine one context with one boundary, then adapt it to your workplace and policies.",
  }),
  bodySignal: Object.freeze({
    type: "body-signal",
    title: "Body-signal check-in",
    intro: "Body signals can be information without being a diagnosis. Notice what is present, then decide what care or support would feel useful.",
    signals: Object.freeze([
      "My jaw, shoulders, or hands feel tense.",
      "My breathing feels faster, shallower, or held.",
      "My stomach or chest feels unsettled.",
      "I feel restless, heavy, numb, or worn out.",
    ]),
    responses: Object.freeze(["Take a short pause", "Drink water or eat something", "Move somewhere quieter", "Reach out to someone I trust"]),
    note: "This check-in does not identify a condition. New, severe, or concerning physical symptoms need appropriate medical attention.",
    fallback: "JavaScript is optional. Read the signals and possible responses as reflection prompts; they do not diagnose anything.",
  }),
  bookingQuestions: Object.freeze({
    type: "booking-questions",
    title: "Questions before booking",
    intro: "A first fit conversation is also your chance to ask how support will work. Keep the questions that matter to you.",
    questions: Object.freeze([
      "What experience do you have with the concern I want to discuss?",
      "How do you explain privacy, its limits, and record keeping?",
      "What happens in a first session, and what choices do I have?",
      "What are the fees, cancellation terms, and available formats?",
      "How do we check whether the fit is working?",
      "What happens if I want a referral or decide not to continue?",
    ]),
    note: "Copy only the questions you select. Your checklist is not saved or sent from this page.",
    fallback: "JavaScript is optional. All booking questions are visible below for manual copying.",
  }),
});
