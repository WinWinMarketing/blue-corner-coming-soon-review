export const sourceCopy = Object.freeze({
  ...
  conversion: Object.freeze({
    ...
    body: "Founding members and founding therapists get in ahead of everyone. Leave your details and we'll reach out the moment we open.",
    ...
    therapist: Object.freeze({
      ...
      button: "Join the corner",
      note: "Lived experience beats a perfect résumé. Registered therapists welcome.",
    }),
